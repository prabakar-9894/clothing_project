...
const BestView = () => {
    const {BestId,BestOfweekCollection,FilProductBest,setFilProductBest} = useContext(ShopContext);

 const [bestOne,setBestOne] = useState(true);
    const [bestTwo,setBestTwo] = useState(false);
    const [bestThree,setBestThree] = useState(false);
    ...
    function PickThree(){
       ...
       useEffect(() => {
                setFilProductBest(BestOfweekCollection.filter((e) => e.Id === BestId)); 
        }, [BestId, BestOfweekCollection]);
